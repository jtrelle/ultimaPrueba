...
function fillArrayExcursion(){
  //$('#tablaUsuarioExcursiones').html("");
  for (const item in arrayListaExcursiones){
    //posicionArrayExcursion = arrayListaExcursiones[item].id -1;
    $( '#tablaUsuarioExcursiones' ).append('<div class="responsive gallery"><button type="button" class="botoncito" style="color:#fff;" onclick="llenarExcursiones(' + arrayListaExcursiones[item].id + ')"><img src="' + arrayListaExcursiones[item].portada + '" alt="Cinque Terre" width="600" height="400"><div class="desc" style="color:#fff;">' + arrayListaExcursiones[item].titulo + '</div></button></div>' );
    //console.log(item);
  }
}
...
function agregarElementoArrayExcursionUsuario(index){
  for (const item in arrayListaExcursiones){
    if(arrayListaExcursiones[item].id == index){
      $( '#tablaUsuarioExcursiones' ).append('<div class="responsive gallery"><button type="button" class="botoncito" style="color:#fff;" onclick="llenarExcursiones(' 
      + arrayListaExcursiones[item].id + ')"><img src="' + arrayListaExcursiones[item].portada + '" alt="Cinque Terre" width="600" height="400"><div class="desc" style="color:#fff;">'  
